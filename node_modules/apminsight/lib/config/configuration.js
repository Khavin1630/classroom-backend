...
function Configuration(options) {
    ...
    // agent level configuration, for cases where automatic detection fails.
    this._explicitHostType = options.explicitHostType || process.env.APMINSIGHT_EXPLICIT_HOST_TYPE || null;
    this._isAutoScaleEnabled = options.isAutoScaleEnabled || (process.env.APMINSIGHT_AUTO_SCALE_ENABLED === 'true') || null;
}
...
Configuration.prototype.getExplicitHostType = function () {
    return this._explicitHostType;
};

Configuration.prototype.isAutoScaleEnabled = function () {
...
function getCollectorHostByLicenseKey(lKey) {
    ...
    if (licenseKey.startsWith("sg_")) {
        return constants.sgCollectorHostName;
    }
