...
const licenseKey = "license.key",
    ...
    sgCollectorHostName = "plusinsight.site24x7.sg",
    ...
    processRuleName = "process.rule.name",
    ...
    shutdown = 0,
    s247ClusterName = "s247_cluster_name",
    s247ClusterNameHeader = "s247cn",
    // namespace
    ...
    site24x7LicenseRegex =
        /^((us|eu|cn|in|in_hd|au|aa|ab|gd|jp|ca|uk|sa|ae|sg)_)?[a-f0-9\s]{0,100}$/,
...
module.exports = {
    ...
    sgCollectorHostName: sgCollectorHostName,
    ...
    shutdown: shutdown,
    s247ClusterName: s247ClusterName,
    s247ClusterNameHeader: s247ClusterNameHeader,
